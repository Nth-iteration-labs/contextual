...
In the next section, we introduce one example of such a counterfactual estimator or bandit by demonstrating \code{contextual}'s implementation of \cite{Li2011}'s "replay" method \citep{Nicol2014}. In a subsequent section, we demonstrate how this "replay" method can be sensitive to certain types of bias---and how inverse propensity weighting can help remove some of these biases.
