...
MAB  & \begin{tabular}[c]{@{}l@{}}$\epsilon$-Greedy (\citeyear{Sutton1998e})\\ $\epsilon$-First (\citeyear{Sutton1998e})\end{tabular} & \begin{tabular}[c]{@{}l@{}}UCB1 (\citeyear{Auer2003})\\ UCB-tuned (\citeyear{Auer2003})\end{tabular} & \begin{tabular}[c]{@{}l@{}}Thompson Sampling (\citeyear{Agrawal2011})\\ BootstrapTS (\citeyear{Eckles2014})\end{tabular} & \begin{tabular}[c]{@{}l@{}}Softmax\\ Gittins\end{tabular} & \multirow{2}{*}{\begin{tabular}[c]{@{}l@{}}Random\\ Oracle\\ LiF\end{tabular}} \\ \cmidrule(r){1-5}
cMAB & Epoch-Greedy                                        & \begin{tabular}[c]{@{}l@{}}LinUCB (\citeyear{Li2010})\\ COFIBA (\citeyear{Li2010})\end{tabular}  & \begin{tabular}[c]{@{}l@{}}LinTS (\citeyear{Agrawal2012a})\\ LogitBTS (\citeyear{Eckles2014})\end{tabular}                                                                   &                                                           &                                                                                \\ \bottomrule
\end{tabular}
...
\hlcom{# Define the probability that each add will be clicked.}
...
\begin{figure}[H]
\centering
\includegraphics[width=.99\textwidth]{fig/ctr_non_context}
\label{fig:ctr_non_context}
\end{figure}
...
But maybe you also know that half of the visitors to your website is younger than forty, and half older. And that one of your adds is more effective for younger visitors, while the other add works better for older visitors. We can simulate this scenario by continuing where the previous script left off:
\begin{knitrout}\small
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
                                \hlcom{#   add1  add2}
...
\begin{figure}[H]
\centering
\includegraphics[width=.99\textwidth]{fig/ctr_context}
\label{fig:ctr_context}
\end{figure}
