...
\caption{Overview hightlighting the versatility of contextual's Plot() class. From left to right, and top to bottom: 1. Grayscale plot 2. Plotting traces 3. Cumulative reward plus dispersion plot (here, SD) 4. Dispersion plot (here, variance) 5. Color plot 6. Arm choice percentage plot   }
