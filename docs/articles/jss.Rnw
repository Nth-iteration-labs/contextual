...
\subsection{\proglang{R} and the R6 Class System}
...
<<label=efplot, size='small',  message = FALSE, fig.show='hold', fig.keep='none'>>=
horizon            <- 100
simulations        <- 100
...
@
\begin{center}
<<label=efpolicy, fig.width=10, fig.height=3.7, fig.keep='high', echo=FALSE, message=FALSE, out.extra='', fig.cap="Epsilon Greedy">>=
<<efplot>>
@
\end{center}
