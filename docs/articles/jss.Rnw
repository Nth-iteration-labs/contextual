...
\begin{center}
<<label=efpolicy, fig.width=10, fig.height=4, fig.keep='high', echo=FALSE, message=FALSE, out.extra='', fig.cap="Epsilon First">>=
<<efplot>>
@
\end{center}
...
\begin{center}
<<label=egpolicy, fig.width=10, fig.height=4, fig.keep='high', echo=FALSE, message=FALSE, out.extra='', fig.cap="Epsilon Greedy">>=
<<egplot>>
@
\end{center}
...
\begin{center}
<<label=poissonplot, fig.width=10, fig.height=4, fig.keep='high', echo=FALSE, message=FALSE, out.extra='', fig.cap="Extending BasicBandit and EpsilonGreedyPolicy">>=
<<poisson>>
@
\end{center}
