...
The current paper presents our package for several audiences:

1: general audience introduction ---> background information on bandit (into, formal), simulate
2: R extension                   --->
