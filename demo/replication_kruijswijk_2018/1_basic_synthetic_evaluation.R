...
agents      <- list(Agent$new(RandomPolicy$new(), bandit),
                    ...
                    Agent$new(PartiallyPooledBBEgreedyPolicy$new(epsilon = 0.1, n_subjects = n_subjects), bandit))
...
agents      <- list(Agent$new(RandomPolicy$new(), bandit),
                    Agent$new(PooledThompsonPolicy$new(), bandit),
...
agents      <- list(Agent$new(RandomPolicy$new(), bandit),
                    ...
                    Agent$new(PartiallyPooledBBUCBPolicy$new(n_subjects = n_subjects), bandit))
...
agents      <- list(Agent$new(PooledUCBPlusPolicy$new(), bandit),
                    Agent$new(UnpooledUCBPlusPolicy$new(n_subjects = n_subjects), bandit),
                    Agent$new(PartiallyPooledUCBPlusPolicy$new(n_subjects = n_subjects), bandit),
                    Agent$new(PartiallyPooledBBUCBPlusPolicy$new(n_subjects = n_subjects), bandit))
