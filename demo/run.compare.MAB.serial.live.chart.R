...
bandit  = SyntheticBandit$new(k = 3L,
                    ...
                    # d1
bandit$set.weights( c(0.1,   #k1                                               # override auto-generated weights
...
simulation     = Simulator$new( agents , animate = TRUE, animate.step = 1)     # let's see what our cunning agent can find out about the bandit
