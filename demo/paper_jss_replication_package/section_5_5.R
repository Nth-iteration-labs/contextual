...
BasicPoissonBandit <- R6::R6Class(
  ...
  public = list(
    ...
    # Overrides BasicBernoulliBandit's get_reward to generate Poisson based rewards
...
plot(history, type = "arms",  limit_agents = c("EG"), no_par = TRUE, interval = 25)
plot(history, type = "arms",  limit_agents = c("EG Annealing"), no_par = TRUE, interval = 25)
par(mfrow = c(1, 1))
