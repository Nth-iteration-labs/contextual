...
#' Bandit: BasicContextualBernoulliBandit
#'
...
#'
#' @name BasicContextualBernoulliBandit
#'
#' @section Usage:
#' \preformatted{
#'   bandit <- BasicContextualBernoulliBandit$new(weights)
#' }
#'
#' @section Arguments:
#'
...
#' \describe{
#'
#'   \item{\code{new(weights)}}{ generates and instantializes a new \code{BasicContextualBernoulliBandit}
#'    instance. }
#'
...
#'
#' Bandit subclass examples: \code{\link{BasicContextualBernoulliBandit}}, \code{\link{ContextualLogitBandit}},  \code{\link{OfflinePolicyEvaluatorBandit}}
#'
...
#'
#' bandit             <- BasicContextualBernoulliBandit$new(weights = c(0.6, 0.1, 0.1))
