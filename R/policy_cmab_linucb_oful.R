#' @export
LinUCBOFULPolicy <- R6::R6Class(
  portable = FALSE,
  class = FALSE,
  inherit = Policy,
  public = list(
    alpha = NULL,
    class_name = "LinUCBOFULPolicy",
    initialize = function() {
      super$initialize()
    },
...
#' Lihong Li et all
#'
#' Each time step t, \code{LinUCBOFULPolicy} runs a linear regression per arm that produces coefficients for each context feature \code{d}.
...
#'
#' @name LinUCBOFULPolicy
#' @family contextual subclasses
#'
#' @section Usage:
#' \preformatted{
#' policy <- LinUCBOFULPolicy(alpha = 1.0)
#' }
#'
#' @section Arguments:
#'
...
#'
#' \describe{
#'   \item{\code{new(alpha = 1)}}{ Generates a new \code{LinUCBOFULPolicy} object. Arguments are defined in the Argument section above.}
#' }
#'
#' \describe{
