---
title: "Contextual: R package for Contextual Multi-Armed Bandit Simulation"
output:
  github_document:
    fig_width: 9
    fig_height: 5
...
knitr::include_graphics("../tools/readme/basic_multi_plot.png")
```
...
```{r echo=FALSE, out.width='100%'}
knitr::include_graphics("../tools/readme/contextual_plot.png")
```
